...
local function TheoryCraft_AddAllBuffs(target, data, buffs)
	...
	local i, buff, locale_table, defaulttarget, _, start, found, t, ltext
	...
	-- Modern Classic clients are no longer limited to the original 16 aura
	-- slots. Stop at the first empty slot and retain a defensive upper bound.
	for i = 1, 255 do
		if buffs == "debuffs" then
