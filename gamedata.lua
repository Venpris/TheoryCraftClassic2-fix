...
TheoryCraft_Spells = {
	["MAGE"] = {
		...
		{ id="Cone of Cold", binary=1, percent=1.5/3.5/3*0.895, cancrit=1, dodps=1, aoe=1, dontdomax=1,
			Schools={ "All", "Damage", "Frost" } },
		{ id="Blizzard", percent=1/3, dodps=1, aoe=1, channeled=1, casttime=8, regencasttime=8, tickinterval=1,
		...
		{ id="Arcane Missiles", level1=8, level1manamult=1/3, level2=16, level2manamult=1/4, percent=1.2/5, dodps=1, manamultiplier=1/5, cancrit=1, channeled=1, casttime=1, regencasttime=1, tickinterval=1,
		...
		{ id="Ice Barrier", isheal=1, percent=0.1, dodps=1, dontdomax=1, talentsbeforegear=1,
			Schools={ "All", "Damage", "Frost" } },
		{ id="Evocation", evocation=1, channeled=1,
			Schools={ } },
...
--			Schools={ } },
		{ id="Conflagrate", percent=1.5/3.5, dodps=1, cancrit=1, dontdomax=1,
			Schools={ "All", "Damage", "Fire", "Destruction" } },
		{ id="Rain of Fire", percent=1/3, dodps=1, aoe=1, channeled=1, casttime=8, regencasttime=8, tickinterval=2,
			Schools={ "All", "Damage", "Fire", "Destruction" }, dot_pattern="overXsec" },
		{ id="Hellfire", percent=1/3.5/3*0.22, dodps=1, aoe=1, channeled=1, casttime=1, regencasttime=15, hellfire=1, tickinterval=1, manamultiplier=1/15,
		...
		{ id="Drain Soul", level1=10, percent=0.5, dodps=1, channeled=1, casttime=15, regencasttime=15, isdot=1, tickinterval=3,
			Schools={ "All", "Damage", "Shadow", "Affliction" }, dot_pattern="overXsec" },
		{ id="Siphon Life", percent=1/20, dodps=1, casttime=3, regencasttime=1.5, manamultiplier=1/10, tickinterval=3, dontdomax=1, drain=1, talentsbeforegear=1, dontdpsafterresists=1, 
			Schools={ "All", "Damage", "Shadow", "Affliction" }, dot_pattern="overXsec" },
		{ id="Drain Life", level1=14, percent=1/10, dodps=1, channeled=1, casttime=1, regencasttime=1, manamultiplier=1/5, tickinterval=1, drain=1, talentsbeforegear=1, dontdpsafterresists=1, -- old percent=1/3.5*0.36
	...
	["PRIEST"] = {
		...
		{ id="Mind Flay", percent=0.457, dodps=1, channeled=1, casttime=3, regencasttime=3,
		...
		{ id="Starshards", level1=10, level2=18, percent=1, dodps=1, channeled=1, casttime=6, regencasttime=6, starshards=1,
			Schools={ "All", "Damage", "Arcane" }, dot_pattern="overXsec" },
		{ id="Shoot", shoot=1, isranged=1, cancrit=1,
			Schools={ } },
		},
	["DRUID"] = {
		...
		{ id="Tranquility", percent=1/3/5, dodps=1, isheal=1, channeled=1, casttime=2, regencasttime=2, manamultiplier=1/5, tickinterval=2, dontdomax=1, talentsbeforegear=1, dontdomax=1,
			Schools={ "All", "Healing", "Restoration" } },
		...
		{ id="Hurricane", talentsbeforegear=1, percent=0.03, dodps=1, channeled=1, casttime=1, regencasttime=1, manamultiplier=1/10, tickinterval=1, dontdomax=1,
...
--			Schools={ "Melee" } },
		{ id="Mend Pet", level1=12, percent=1/5, dodps=1, manamultiplier=1/5, channeled=1, casttime=1, regencasttime=1, tickinterval=1, isheal=1, talentsbeforegear=1,
		...
		{ id="Volley", percent=1/3/6, dodps=1, channeled=1, casttime=1, regencasttime=1, manamultiplier=1/6, tickinterval=1, dontdomax=1,
